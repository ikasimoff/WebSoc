...
namespace InstagramApiSharp.Classes.ResponseWrappers
{
    public class InstaUserInfoResponse
    {
        ...
        [JsonProperty("public_email")] public string Email { get; set; }
        [JsonProperty("public_phone_number")] public string Phone { get; set; }
        [JsonProperty("contact_phone_number")] public string Phone2 { get; set; }
